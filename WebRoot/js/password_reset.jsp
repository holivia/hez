 ...
 <script language="javascript" type="text/javascript">
  ...
  <body ">
    <div id="login_top"><img src="images/login_top.png" /></div>
         <form id="form2" onsubmit="return checkPassword()" action="resetPassword" method="post">
        <div id="login_cent1">
        <div id="d"><div id="td2">2重置密码</div> <hr/></div>
           <div id="div_in">      
           ...
           <tr><td><input type="hidden" value=${requestScope.accountNumber} name="accountNumber"></input></td></tr>
    		...
    		<tr>
            	<td height="30">请输入邮箱验证码：</td>
            	<td height="30"><input  type="text" placeholder="邮箱验证码" name="inputCode" /></td>
            </tr>
            <tr>
            	<td height="30">请输入您的新密码：</td>
            	<td height="30"><input id="p" type="text" placeholder="密码不能为空" name="newPasswod" /></td>
            </tr>
           <tr>
           <td>输入确认密码:</td>
