...
$(document).ready(function() {  
  ...
  <body>
	...
	<div class="fill-icon">
				...
				<div class="icon"><img src="images/gs_find.png"/><span><a id="span-gs" href="">工时查询</a></span></div>
				<div class="icon"><img src="images/count.png"/><span><a id="span-count" href="">统计报表</a></span></div>
				<div class="icon"><img src="images/team_information.png"/><span><a id="span-team" href="">团队信息</a></span></div>
			</div>
				...
				<div class="td_border">
					<table>
						<tr>
							...
							<td class="name"><a href="js/personal_centre.jsp">金莲莲</a></td>
        ...
        <div style="position:absolute;top:170px;right:1px; width=100%" id="to">
				<div class="line"></div>
			  ...
			  <div  style="position:absolute;top:200px;right:0px;width=100%" id="container" ></div>			
