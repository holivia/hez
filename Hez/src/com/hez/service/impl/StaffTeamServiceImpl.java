...
public class StaffTeamServiceImpl implements StaffTeamService{
	...
	public int selectId(int teamid, int staffid) {
		// TODO Auto-generated method stub
		return StaffTeamDao.selectId(teamid, staffid);
	}

	public List<StaffTeam> selectStaffTeamById(int id) {
		// TODO Auto-generated method stub
		return StaffTeamDao.selectStaffTeamById(id);
	}

	public int updateTeamid(Integer teamid, Integer staffteamid) {
		// TODO Auto-generated method stub
		return StaffTeamDao.updateTeamid(teamid, staffteamid);
	}
