...
<html>
  <head>
   ...
   <div id="div_all">
			<div id="div_top">
				<form action="selectOvertime?index=0" method="post">
					<table id="t1">
						<tr>
				...
				<div id="">
				<a href="selectOvertimeExecl">
				<input type="button" id="moban_out" value="导出查询结果">
				</a></div>
			</div>
				...
				<div id="auto">
					<table border="0">
						<tr>
							...
							<td align="right"> ${indexInfo}</td>
								<td><a href="selectOvertime?index=1" target="_self"> <input type="button" value="上一页" /> </a></td>
								<td><a href="selectOvertime?index=2" target="_self"> <input type="button" value="下一页" /> </a></td>				
						</tr>
					</table>
